...
export default function TaxManagementInlineForm({
  setOpen,
  refetchList,
  selectedItem,
  setSelectedItem,
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    if (selectedItem) {
      ...
      try {
        ...
        toast.success(`Tax Management created successfully`);
        afterSubmit();
      } catch (error) {
        toast.error('Failed to create Tax Management');
      }
    }
  }
            ...
            <CardContent className='form-dynamic-height overflow-y-auto px-6'>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem viewType='inline' className='flex items-center'>
                      <FormLabel className='w-[15%]'>Tax Name</FormLabel>
              ...
              <div className='mb-6 grid grid-cols-1 gap-6'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem viewType='inline' className='flex items-center'>
                      <FormLabel className='w-[15%]'>Tax Type</FormLabel>
                      <div className='flex w-[85%] flex-col'>
                        <FormControl>
                          <Input type='text' {...field} />
                        </FormControl>
              ...
              <div className='mb-6 grid grid-cols-1 gap-6'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem viewType='inline' className='flex items-center'>
                      <FormLabel className='w-[15%]'>Tax Prct</FormLabel>
                      <div className='flex w-[85%] flex-col'>
                        <FormControl>
                          <Input type='text' {...field} />
                        </FormControl>
