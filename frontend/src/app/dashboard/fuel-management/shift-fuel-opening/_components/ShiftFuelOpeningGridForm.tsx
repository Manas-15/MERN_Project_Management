...
export default function ShiftFuelOpeningGridForm({
  setOpen,
  refetchList,
  selectedItem,
  setSelectedItem,
  ...
  const defaultValues = {
    ...
    previous_opening_balance: selectedItem?.previous_opening_balance || 0,
    opening_balance: selectedItem?.opening_balance || 0,
