...
export default function PurchaseRequisitionItemsInlineForm({
  setOpen,
  refetchList,
  selectedItem,
  setSelectedItem,
...
const defaultValues = {
         ...
         indent_quantity: selectedItem?.indent_quantity || "",
         requisition_quantity: selectedItem?.requisition_quantity || "",
             ...
             <CardContent className='form-dynamic-height overflow-y-auto px-6'>
                          ...
                          <div className="mb-6 grid grid-cols-1 gap-6">
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem viewType='inline' className='flex items-center'>
                                    <FormLabel className='w-[15%]'>Requisition Quantity</FormLabel>
                                    <div className='flex w-[85%] flex-col'>
                                        <FormControl>
                                          <Input type='text' {...field} />
                                        </FormControl>
