...
export default function PurchaseOrdersGridForm({
  setOpen,
  refetchList,
  selectedItem,
  setSelectedItem,
  ...
  const [createTrnPurchaseOrder] =
    useCreateTrnPurchaseOrderTrnPurchaseOrderPostMutation();
  const [updateTrnPurchaseOrder] =
    useUpdateTrnPurchaseOrderTrnPurchaseOrderIdPutMutation();
  ...
  const defaultValues = {
    ...
    update_item_purchase_price:
      selectedItem?.update_item_purchase_price || false,
    update_item_consumption_price:
      selectedItem?.update_item_consumption_price || false,
