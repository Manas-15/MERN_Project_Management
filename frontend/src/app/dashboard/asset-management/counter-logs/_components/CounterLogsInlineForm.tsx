...
export default function CounterLogsInlineForm({
  setOpen,
  refetchList,
  selectedItem,
  setSelectedItem,
  ...
  const defaultValues = {
    ...
    hours_previous_shift_reading:
      selectedItem?.hours_previous_shift_reading || '',
    hours_current_log_reading: selectedItem?.hours_current_log_reading || '',
    drum_hours_previous_shift_reading:
      selectedItem?.drum_hours_previous_shift_reading || '',
    drum_hours_current_log_reading:
      selectedItem?.drum_hours_current_log_reading || '',
    ...
    hours_absolute_running: selectedItem?.hours_absolute_running || '',
    drum_absolute_running: selectedItem?.drum_absolute_running || '',
