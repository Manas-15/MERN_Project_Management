...
export default function ItemOpeningBalancesInlineForm({
  setOpen,
  refetchList,
  selectedItem,
  setSelectedItem,
  ...
  const defaultValues = {
    ...
    balance_quantity: selectedItem?.balance_quantity || '',
    item_unit_rate: selectedItem?.item_unit_rate || '',
            ...
            <CardContent className='form-dynamic-height overflow-y-auto px-6'>
              ...
              <div className='mb-6 grid grid-cols-1 gap-6'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem viewType='inline' className='flex items-center'>
                      <FormLabel className='w-[15%]'>Item Unit Rate</FormLabel>
                      <div className='flex w-[85%] flex-col'>
                        <FormControl>
                          <Input type='text' {...field} />
                        </FormControl>
