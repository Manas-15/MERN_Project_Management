...
export default function ItemTransferDetailsInlineForm({
  setOpen,
  refetchList,
  selectedItem,
  setSelectedItem,
             ...
             <CardContent className='form-dynamic-height overflow-y-auto px-6'>
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                 <FormItem viewType='inline' className='flex items-center'>
                                    <FormLabel className='w-[15%]'>Indent Id</FormLabel>
                          ...
                          <div className="mb-6 grid grid-cols-1 gap-6">
                              <FormField
                                ...
                                render={({ field }) => (
                                 <FormItem viewType='inline' className='flex items-center'>
                                    <FormLabel className='w-[15%]'>Demand Prending Qty</FormLabel>
                                    <div className='flex w-[85%] flex-col'>
                                      <FormControl>
                                        <Input type='number' {...field} />
                                      </FormControl>
