...
const formSchema = z.object({
  ...
  allocation_for: z.string().nonempty({
    message: 'Allocation For is required'
  }),
...
export default function AllocationsInlineForm({
  setOpen,
  refetchList,
  selectedItem,
  setSelectedItem,
  ...
  const defaultValues = {
    ...
    allocation_for: selectedItem?.allocation_for || '',
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    if (selectedItem) {
      ...
      try {
        await createTrnInvAllocation({
          ...tenantIDHeader(),
          trnInvAllocationInsert: values
        }).unwrap();
            ...
            <CardContent className='form-dynamic-height overflow-y-auto px-6'>
              ...
              <div className='mb-6 grid grid-cols-1 gap-6'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem viewType='inline' className='flex items-center'>
                      <FormLabel className='w-[15%]'>Allocation For</FormLabel>
                      <div className='flex w-[85%] flex-col'>
                        <FormControl>
                          <Input type='text' {...field} />
                        </FormControl>
              ...
              <div className='mb-6 grid grid-cols-1 gap-6'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem viewType='inline' className='flex items-center'>
                      <FormLabel className='w-[15%]'>Voucher Number</FormLabel>
                      <div className='flex w-[85%] flex-col'>
                        <FormControl>
                          <Input type='text' {...field} />
                        </FormControl>
              ...
              <div className='mb-6 grid grid-cols-1 gap-6'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem viewType='inline' className='flex items-center'>
                      <FormLabel className='w-[15%]'>Note</FormLabel>
                      <div className='flex w-[85%] flex-col'>
                        <FormControl>
                          <Input type='text' {...field} />
                        </FormControl>
