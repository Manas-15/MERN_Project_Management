...
export default function WarehouseIndentItemsGlobalForm({
  setOpen,
  refetchList,
  selectedItem,
  setSelectedItem,
 ...
 const [createTrnWarehouseIndentItems] = useCreateTrnWarehouseIndentItemsTrnWarehouseIndentItemsPostMutation();
    ...
    if (selectedItem) {
      try {
        await updateTrnWarehouseIndentItems({
           ...tenantIDHeader(),
          id: selectedItem.id,
          trnWarehouseIndentItemsUpdate: values
        }).unwrap();
      ...
      try {
        await createTrnWarehouseIndentItems({
           ...tenantIDHeader(),
          trnWarehouseIndentItemsInsert: values
        }).unwrap();
        toast.success(`Warehouse Indent Items created successfully`);
        afterSubmit();
      } catch (error) {
        toast.error('Failed to create Warehouse Indent Items');
      }
    }
  }
