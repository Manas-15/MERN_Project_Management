...
const formSchema = z.object({
            ...
            wrehouse_id: z.number().min(1, {
              message: 'Wrehouse Id is required'
            }),
            wrehouse_name: z.string().nonempty({
              message: 'Wrehouse Name is required'
            }),
            bin_location: z.string().nonempty({
            ...
            min_level: z.number().min(1, {
              message: 'Min Level is required'
            }),
            reorder_level: z.number().min(1, {
              message: 'Reorder Level is required'
            }),
            replacement_period: z.number().min(1, {
              message: 'Replacement Period is required'
            }),
            create_by: z.string(),
});
...
export default function ItemConfigurationsInlineForm({
  setOpen,
  refetchList,
  selectedItem,
  setSelectedItem,
...
const [createInvItemConfiguration] = useCreateInvItemConfigurationInvItemConfigurationPostMutation();
const [updateInvItemConfiguration] = useUpdateInvItemConfigurationInvItemConfigurationIdPutMutation();
...
const defaultValues = {
         ...
         wrehouse_id: selectedItem?.wrehouse_id || 0,
         wrehouse_name: selectedItem?.wrehouse_name || "",
         bin_location: selectedItem?.bin_location || "",
         max_level: selectedItem?.max_level || "",
         min_level: selectedItem?.min_level || "",
         reorder_level: selectedItem?.reorder_level || "",
         replacement_period: selectedItem?.replacement_period || 0,
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    if (selectedItem) {
      try {
        await updateInvItemConfiguration({
           ...tenantIDHeader(),
          id: selectedItem.id,
          invItemConfigurationUpdate: values
        }).unwrap();
        toast.success(`Item Configurations updated successfully`);
        afterSubmit();
      } catch (error) {
        toast.error('Failed to update Item Configurations');
      }
    } else {
      try {
        await createInvItemConfiguration({
           ...tenantIDHeader(),
          invItemConfigurationInsert: values
        }).unwrap();
        toast.success(`Item Configurations created successfully`);
        afterSubmit();
      } catch (error) {
        toast.error('Failed to create Item Configurations');
      }
    }
  }
             ...
             <CardContent className='form-dynamic-height overflow-y-auto px-6'>
                          ...
                          <div className="mb-6 grid grid-cols-1 gap-6">
                              <Controller
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    <FormLabel>Wrehouse Id</FormLabel>
                                    <MultiSelectSearchDropdown
                                      {...field} // Spread the form field props
                                      keyName="wrehouse_id"
                                      isSearchable={true}
                          ...
                          <div className="mb-6 grid grid-cols-1 gap-6">
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem viewType='inline' className='flex items-center'>
                                    <FormLabel className='w-[15%]'>Wrehouse Name</FormLabel>
                                    <div className='flex w-[85%] flex-col'>
                                        <FormControl>
                                          <Input type='text' {...field} />
                                        </FormControl>
                          ...
                          <div className="mb-6 grid grid-cols-1 gap-6">
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem viewType='inline' className='flex items-center'>
                                    <FormLabel className='w-[15%]'>Bin Location</FormLabel>
                                    <div className='flex w-[85%] flex-col'>
                                        <FormControl>
                                          <Input type='text' {...field} />
                                        </FormControl>
                          ...
                          <div className="mb-6 grid grid-cols-1 gap-6">
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem viewType='inline' className='flex items-center'>
                                    <FormLabel className='w-[15%]'>Max Level</FormLabel>
                                    <div className='flex w-[85%] flex-col'>
                                        <FormControl>
                                          <Input type='text' {...field} />
                                        </FormControl>
                          ...
                          <div className="mb-6 grid grid-cols-1 gap-6">
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem viewType='inline' className='flex items-center'>
                                    <FormLabel className='w-[15%]'>Min Level</FormLabel>
                                    <div className='flex w-[85%] flex-col'>
                                        <FormControl>
                                          <Input type='text' {...field} />
                                        </FormControl>
                          ...
                          <div className="mb-6 grid grid-cols-1 gap-6">
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem viewType='inline' className='flex items-center'>
                                    <FormLabel className='w-[15%]'>Reorder Level</FormLabel>
                                    <div className='flex w-[85%] flex-col'>
                                        <FormControl>
                                          <Input type='text' {...field} />
                                        </FormControl>
                          ...
                          <div className="mb-6 grid grid-cols-1 gap-6">
                              <FormField
                                ...
                                render={({ field }) => (
                                 <FormItem viewType='inline' className='flex items-center'>
                                    <FormLabel className='w-[15%]'>Replacement Period</FormLabel>
                                    <div className='flex w-[85%] flex-col'>
                                      <FormControl>
