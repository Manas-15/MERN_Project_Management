...
export default function ItemConfigurationsGridForm({
  setOpen,
  refetchList,
  selectedItem,
  setSelectedItem,
...
const defaultValues = {
         ...
         max_level: selectedItem?.max_level || 0,
         min_level: selectedItem?.min_level || 0,
            ...
            <CardContent className='form-dynamic-height overflow-y-auto px-6'>
                            ...
                            <div className="mb-6 grid grid-cols-1 gap-6 md:grid-cols-2">
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    <FormLabel>Wrehouse Name</FormLabel>
                                    <FormControl>
                                      <Input type='text' {...field} />
                                    </FormControl>
                                    <FormMessage />
                            ...
                            <div className="mb-6 grid grid-cols-1 gap-6 md:grid-cols-2">
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    <FormLabel>Replacement Period</FormLabel>
                                    <FormControl>
                                      <Input type='number' {...field} />
                                    </FormControl>
                                    <FormMessage />
