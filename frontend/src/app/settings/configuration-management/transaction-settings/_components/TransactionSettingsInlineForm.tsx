...
export default function TransactionSettingsInlineForm({
  setOpen,
  refetchList,
  selectedItem,
  setSelectedItem,
            ...
            <CardContent className='form-dynamic-height overflow-y-auto px-6'>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem viewType='inline' className='flex items-center'>
                      <FormLabel className='w-[15%]'>Prefix</FormLabel>
              ...
              <div className='mb-6 grid grid-cols-1 gap-6'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem viewType='inline' className='flex items-center'>
                      <FormLabel className='w-[15%]'>Num Fmt</FormLabel>
                      <div className='flex w-[85%] flex-col'>
                        <FormControl>
                          <Input type='text' {...field} />
                        </FormControl>
              ...
              <div className='mb-6 grid grid-cols-1 gap-6'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem viewType='inline' className='flex items-center'>
                      <FormLabel className='w-[15%]'>Applicable Date</FormLabel>
                      <div className='flex w-[85%] flex-col'>
                        <FormControl>
                          <Input type='text' {...field} />
                        </FormControl>
