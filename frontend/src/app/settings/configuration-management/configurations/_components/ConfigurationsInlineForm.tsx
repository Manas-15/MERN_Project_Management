...
export default function ConfigurationsInlineForm({
  setOpen,
  refetchList,
  selectedItem,
  setSelectedItem,
...
const [createSaasRefConfigurations] = useCreateSaasRefConfigurationsSaasRefConfigurationsPostMutation();
    ...
    if (selectedItem) {
      try {
        await updateSaasRefConfigurations({
           ...tenantIDHeader(),
          id: selectedItem.id,
          saasRefConfigurationsUpdate: values
        }).unwrap();
      ...
      try {
        await createSaasRefConfigurations({
           ...tenantIDHeader(),
          saasRefConfigurationsInsert: values
        }).unwrap();
             ...
             <CardContent className='form-dynamic-height overflow-y-auto px-6'>
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem viewType='inline' className='flex items-center'>
                                    <FormLabel className='w-[15%]'>Config Name</FormLabel>
                          ...
                          <div className="mb-6 grid grid-cols-1 gap-6">
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem viewType='inline' className='flex items-center'>
                                    <FormLabel className='w-[15%]'>Config Note</FormLabel>
                                    <div className='flex w-[85%] flex-col'>
                                        <FormControl>
                                          <Input type='text' {...field} />
                                        </FormControl>
