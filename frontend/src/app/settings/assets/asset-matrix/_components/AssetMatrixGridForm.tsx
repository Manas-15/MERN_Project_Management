...
export default function AssetMatrixGridForm({
  setOpen,
  refetchList,
  selectedItem,
  setSelectedItem,
...
const defaultValues = {
         ...
         fuel_tank_capacity: selectedItem?.fuel_tank_capacity || 0,
            ...
            <CardContent className='form-dynamic-height overflow-y-auto px-6'>
                            ...
                            <div className="mb-6 grid grid-cols-1 gap-6 md:grid-cols-2">
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    <FormLabel>Asset Capacity</FormLabel>
                                    <FormControl>
                                      <Input type='text' {...field} />
                                    </FormControl>
                                    <FormMessage />
                            ...
                            <div className="mb-6 grid grid-cols-1 gap-6 md:grid-cols-2">
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    <FormLabel>Electrical Systme</FormLabel>
                                    <FormControl>
                                      <Input type='text' {...field} />
                                    </FormControl>
                                    <FormMessage />
