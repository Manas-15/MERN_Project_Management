...
export default function SubAssemblyCategoriesInlineForm({
  setOpen,
  refetchList,
  selectedItem,
  setSelectedItem,
...
const [createSetAstSubAssemblyCategory] = useCreateSetAstSubAssemblyCategorySetAstSubAssemblyCategoryPostMutation();
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem viewType='inline' className='flex items-center'>
                                    <FormLabel className='w-[15%]'>Category Name</FormLabel>
