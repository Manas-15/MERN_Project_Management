...
function SubAssemblyCategoriesDetails({id}: { id: number }) {
  ...
  const [isDeleteModalOpen, setIsDeleteModalOpen] = useState(false);
   ...
   const { data: fetchedSetAstSubAssemblyCategoryDetails,
  ...
  const handelClose = () => {
    router.push(`/settings/assets/sub-assembly-categories`);
  };
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p></p>
                        <p>{fetchedSetAstSubAssemblyCategoryDetails?.category_name }</p>
                      </div>
                      ...
                      <div>
                        ...
                        <p></p>
                        <p>{fetchedSetAstSubAssemblyCategoryDetails?.search_vector }</p>
                      </div>
