...
import { useGetAllSetAstActivityNamessSetAstActivityNamesGetQuery } from '@/redux/store/generatedServices/assetApi';
...
export default function SiteActivitiesForm({
  setOpen,
  refetchList,
  selectedItem,
  setSelectedItem,
  ...
  const [createSetAstSiteActivity] =
    useCreateSetAstSiteActivitySetAstSiteActivityPostMutation();
  const [updateSetAstSiteActivity] =
    useUpdateSetAstSiteActivitySetAstSiteActivityIdPutMutation();
