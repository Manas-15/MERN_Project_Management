...
export default function TicketTypesInlineForm({
  setOpen,
  refetchList,
  selectedItem,
  setSelectedItem,
...
const [createSetAstTicketType] = useCreateSetAstTicketTypeSetAstTicketTypePostMutation();
             ...
             <CardContent className='form-dynamic-height overflow-y-auto px-6'>
                          ...
                          <div className="mb-6 grid grid-cols-1 gap-6">
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem viewType='inline' className='flex items-center'>
                                    <FormLabel className='w-[15%]'>Ticket Type Note</FormLabel>
                                    <div className='flex w-[85%] flex-col'>
                                        <FormControl>
                                          <Input type='text' {...field} />
                                        </FormControl>
